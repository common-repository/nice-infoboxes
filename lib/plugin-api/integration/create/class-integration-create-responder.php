...
/**
 * Class Nice_Infoboxes_IntegrationCreateResponder
 *
 * This class takes charge of the interaction of created
 * Nice_Infoboxes_Integration instances with WordPress APIs.
 *
 * @see   Nice_Infoboxes_Integration
 *
 * @since 1.0
 */
class Nice_Infoboxes_IntegrationCreateResponder extends Nice_Infoboxes_CreateResponder {
	/**
	...
	public function load_integration() {
		...
		if ( $load && file_exists( $data->path ) ) {
			nice_infoboxes_autoload( $data->path );
		}
	}
