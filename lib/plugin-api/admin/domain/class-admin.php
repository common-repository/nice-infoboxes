...
/**
 * Class Nice_Infoboxes_Admin
 *
 * Main plugin class for admin facing side of WordPress plugins.
 *
 * @since 1.0
 */
class Nice_Infoboxes_Admin extends Nice_Infoboxes_Entity {
	/**
	 * List of admin-side representations of custom post types.
	 *
	 * @see   Nice_Infoboxes_Post_Type_Admin
	 *
	 * @since 1.0
	 * @var   array
	 */
	 ...
	 *
	 * @since 1.0
	 * @var   Nice_Infoboxes_Pointer_Collection
	 */
