...
/**
 * Class Nice_Infoboxes_i18nDisplayResponder
 *
 * This class takes charge of the Nice_Infoboxes_i18n instances to be
 * displayed through WordPress APIs.
 *
 * @since 1.0
 */
class Nice_Infoboxes_i18nCreateResponder extends Nice_Infoboxes_CreateResponder {
	/**
