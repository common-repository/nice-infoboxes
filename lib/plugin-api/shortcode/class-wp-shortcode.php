...
/**
 * Class Nice_Infoboxes_WP_Shortcode
 *
 ...
 */
abstract class Nice_Infoboxes_WP_Shortcode {
	/**
	...
	protected function set_output() {
		 ...
		 */
		nice_infoboxes_set_current_shortcode( $this );
		 ...
		 */
		nice_infoboxes_get_template( $this->template );
		 ...
		 * Unset the shortcode.
		 */
		nice_infoboxes_unset_current_shortcode();
	}
}
