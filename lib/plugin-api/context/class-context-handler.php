...
/**
 * Class Nice_Infoboxes_Context_Handler
 *
...
class Nice_Infoboxes_Context_Handler {
	...
	protected function get_current_context() {
		...
		if ( function_exists( 'nice_infoboxes_doing_shortcode' ) && nice_infoboxes_doing_shortcode() ) {
			$context = 'shortcode';
		}

		if ( is_null( $context ) && function_exists( 'nice_infoboxes_doing_widget' ) && nice_infoboxes_doing_widget() ) {
			$context = 'widget';
		}
