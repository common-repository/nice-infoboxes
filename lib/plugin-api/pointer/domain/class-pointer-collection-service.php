...
/**
 * Class Nice_Infoboxes_Pointer_CollectionService
 *
 * This class deals with typical operations over Nice_Infoboxes_Pointer instances.
 *
 * @package Nice_Infoboxes_Plugin_API
 * @author  NiceThemes <hello@nicethemes.com>
 * @since   1.0
 */
class Nice_Infoboxes_Pointer_CollectionService extends Nice_Infoboxes_Service {
	/**
	 ...
	 * @since 1.0
	 *
	 * @param Nice_Infoboxes_Pointer_Collection $instance
	 * @param Nice_Infoboxes_Pointer            $pointer
	 */
	public function add_pointer(
		Nice_Infoboxes_Pointer_Collection $instance,
		Nice_Infoboxes_Pointer $pointer
	) {
