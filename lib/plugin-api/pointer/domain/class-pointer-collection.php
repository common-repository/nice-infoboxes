...
if ( ! class_exists( 'Nice_Infoboxes_Pointer_Collection' ) ) :
/**
 * Class Nice_Infoboxes_Pointer_Collection
 *
 ...
 */
class Nice_Infoboxes_Pointer_Collection extends Nice_Infoboxes_Entity {
	/**
	 * List of Nice_Infoboxes_Pointer instances.
	 *
	 * @since 1.0
	 * @var   array
	 */
