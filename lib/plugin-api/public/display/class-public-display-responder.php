...
/**
 * Class Nice_Infoboxes_PublicDisplayResponder
 *
 * This class takes charge of the Nice_Infoboxes_Public instances to be
 * displayed through WordPress APIs.
 *
 * @since   1.0
 */
class Nice_Infoboxes_PublicDisplayResponder extends Nice_Infoboxes_DisplayResponder {
	/**
	...
	public function setup_page() {
		/**
		 * @hook nice_infoboxes_setup_page
		 *
		 ...
		 * @since 1.0
		 */
		do_action( 'nice_infoboxes_setup_page' );
	}
	...
	public function template_include( $template ) {
		/**
		 * @hook nice_infoboxes_template_include
		 *
		 * All template modifications for this plugin should be hooked here.
		 *
		 * @since 1.0
		 */
		return apply_filters( 'nice_infoboxes_template_include', $template, $this->data->get_info() );
	}
	...
	public function enqueue_styles() {
		do_action( 'nice_infoboxes_plugin_enqueue_styles', $this->data->get_info() );
	}
	...
	public function enqueue_scripts() {
		do_action( 'nice_infoboxes_plugin_enqueue_scripts', $this->data->get_info() );
	}
}
