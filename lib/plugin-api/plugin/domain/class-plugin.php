 ...
 * @since   1.0
 */
class Nice_Infoboxes_Plugin extends Nice_Infoboxes_Entity {
	/**
	 ...
	 * @var   string
	 */
	protected $settings_name = 'nice_infoboxes_settings';
	 ...
	 *
	 * @since 1.0
	 * @var   Nice_Infoboxes_i18n
	 */
	protected $i18n = null;

	/**
	 * List of Nice_Infoboxes_Post_Type instances.
	 *
	 * @since 1.0
	 * @var   array
	 */
