 ...
 *
 * Hook origin:
 * @see Nice_Infoboxes_MetaboxCreateResponder::loaded()
 */
add_action( 'nice_infoboxes_metabox_created', 'nice_infoboxes_display' );
 ...
 * @since 1.0
 *
 * @uses  nice_infoboxes_update()
 *
 * Hook origin:
 * @see Nice_Infoboxes_MetaboxCreateResponder::loaded()
 */
add_action( 'nice_infoboxes_metabox_created', 'nice_infoboxes_update' );
