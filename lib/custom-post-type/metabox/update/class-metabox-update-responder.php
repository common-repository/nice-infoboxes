...
/**
 * Class Nice_Infoboxes_MetaboxUpdateResponder
 *
 * This class takes charge of the interaction of updated Nice_Infoboxes_Metabox
 * instances with WordPress APIs.
 *
 * @since 1.1
 */
class Nice_Infoboxes_MetaboxUpdateResponder extends Nice_Infoboxes_UpdateResponder {
	/**
