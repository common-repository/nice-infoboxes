...
/**
 * Class Nice_Infoboxes_MetaboxDisplayResponder
 *
 * This class takes charge of the Nice_Infoboxes_Metabox instances
 * to be displayed through WordPress APIs.
 *
 * @since 1.1
 */
class Nice_Infoboxes_MetaboxDisplayResponder extends Nice_Infoboxes_DisplayResponder {
	/**
	...
	protected function set_interactions() {
		/**
		 * Print metabox when the `nice_infoboxes_metabox` action is called.
		 */
		add_action( 'nice_infoboxes_metabox', array( $this, 'print_metabox' ) );
	 ...
	 * @since 1.1
	 *
	 * @param Nice_Infoboxes_Metabox $metabox
	 */
	public static function print_metabox( Nice_Infoboxes_Metabox $metabox ) {
		 ...
		 */
		$html_handler = new Nice_Infoboxes_Metabox_HTMLHandler( $metabox );
	...
	public static function print_styles() {
		...
		<style type="text/css">
			...
			#nice-metabox td .nice_infoboxes_textarea { width:80%; height:100px;margin:0 0 10px 0; color:#222;padding: 5px; }
