...
/**
 * Class Nice_Infoboxes_GlancerDisplayResponder
 *
 * This class takes charge of the Nice_Infoboxes_Glancer instances to be
 * displayed through WordPress APIs.
 *
 * @since 1.1
 */
class Nice_Infoboxes_GlancerDisplayResponder extends Nice_Infoboxes_DisplayResponder {
	/**
	 * Fire main responder functionality.
	 *
	 * @since 1.1
	 *
	 * @param Nice_Infoboxes_EntityInterface $glancer Initialised glancer instance.
	 */
	public function __invoke( Nice_Infoboxes_EntityInterface $glancer ) {
		global $wp_version;
	 ...
	 *
	 * @uses  Nice_Infoboxes_GlancerDisplayResponder::get_single_item()
	 *
	 * @since 1.1
	 */
	 ...
	 *
	 * @uses   Nice_Infoboxes_GlancerDisplayResponder::get_markup()
	 *
	 * @since  1.1
	 *
