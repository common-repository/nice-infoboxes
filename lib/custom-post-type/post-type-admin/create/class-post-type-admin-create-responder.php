...
/**
 * Class Nice_Infoboxes_Post_Type_AdminCreateResponder
 *
 * This class takes charge of the interaction of created Nice_Infoboxes_Post_Type_Admin
 * instances with WordPress APIs.
 *
 * @since 1.1
 */
class Nice_Infoboxes_Post_Type_AdminCreateResponder extends Nice_Infoboxes_CreateResponder {
	/**
	 * Fire main responder functionality.
	 *
	 * @since 1.1
	 *
	 * @param Nice_Infoboxes_EntityInterface $post_type_admin
	 */
	public function __invoke( Nice_Infoboxes_EntityInterface $post_type_admin ) {
