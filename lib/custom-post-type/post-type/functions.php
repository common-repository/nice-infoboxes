...
if ( ! function_exists( 'nice_infoboxes_post_type_register' ) ) :
/**
 * Register a new custom post type.
 *
 * @uses  Nice_Infoboxes_Helper::register_custom_post_type()
 *
 * @since 1.1
 *
 * Accepted $args:
 ...
 */
function nice_infoboxes_post_type_register( $args = array(), $textdomain ) {
	$post_type = nice_infoboxes_post_type_create( array(
	 ...
	 */
	if ( is_admin() ) {
		nice_infoboxes_post_type_admin_create( array(
				'post_type'  => $post_type,
				'textdomain' => $textdomain,
			)
		);
 ...
 *
 * @return Nice_Infoboxes_Post_TypeService
 */
function nice_infoboxes_post_type_create( array $data = array() ) {
	return nice_infoboxes_create( 'Nice_Infoboxes_Post_Type', $data );
}
 ...
 * @return Nice_Infoboxes_Post_TypeService
 */
function nice_infoboxes_post_type_service() {
	return nice_infoboxes_service( 'Nice_Infoboxes_Post_Type' );
}
