...
if ( ! class_exists( 'Nice_Infoboxes_Post_Type_Registrations' ) ) :
/**
 ...
 * @since   1.1
 */
class Nice_Infoboxes_Post_Type extends Nice_Infoboxes_Entity {
	/**
	 ...
	 * @var string
	 */
	protected $textdomain = 'nice-infoboxes-post-type';
}
endif;
