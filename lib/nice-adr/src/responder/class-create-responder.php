...
/**
 * Class Nice_Infoboxes_CreateResponder
 *
 ...
 * @since 1.0
 */
class Nice_Infoboxes_CreateResponder extends Nice_Infoboxes_ResponderAbstract {
	/**
	...
	protected function load_libraries() {
		nice_infoboxes_autoload_libraries( apply_filters( $this->domain . '_libraries', array(), $this->data ) );
	}
