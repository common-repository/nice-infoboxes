...
/**
 * Class Nice_Infoboxes_ResponderAbstract
 *
 ...
 * @since 1.0
 */
abstract class Nice_Infoboxes_ResponderAbstract implements Nice_Infoboxes_ResponderInterface {
	/**
	 * Current Nice_Infoboxes_Entity instance.
	 *
	 ...
	 * @since 1.0
	 *
	 * @param Nice_Infoboxes_EntityInterface $data Current Nice_Infoboxes_EntityInterface instance.
	 */
	protected function set_data( Nice_Infoboxes_EntityInterface $data ) {
		/**
	 ...
	 * @param Nice_Infoboxes_EntityInterface $instance
	 */
	protected function set_domain( Nice_Infoboxes_EntityInterface $instance ) {
		/**
		 * Set current state of data.
		 */
