...
/**
 * Class Nice_Infoboxes_Admin_UICreateResponder
 *
 * This class takes charge of the interaction of created Nice_Infoboxes_Admin_UI
 * instances with WordPress APIs.
 *
 * @since 1.0
 */
class Nice_Infoboxes_Admin_UICreateResponder extends Nice_Infoboxes_CreateResponder {
	/**
